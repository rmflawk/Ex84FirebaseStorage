package com.youngstudio.ex84firebasestorage;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickLoad(View view) {
        ...
        StorageReference imgRef= rootRef.child("dao.png");
        //하위 폴더가 있다면 폴더명까지 포함하여
        imgRef= rootRef.child("photo/dao.png");
    ...
    public void clickUpload(View view) {
        ...
        //firebase storage에 upload하기

        //1. FirebaseStotage을 관리하는 객체 얻어오기
        FirebaseStorage firebaseStorage= FirebaseStorage.getInstance();
        ...
        //원래 확장자는 실제 확장자를 얻어와서 사용해야 함 그러려면 이미지의 절대주소를 구해야함

        StorageReference imgRef= firebaseStorage.getReference("uploads/"+filename); // 폴더가 ㅇ벗으면 자동 생성

        //참조객체를 통해 이미지 파일을 업로드
        ...
        //업로드한 파일의 경로를  firebase DB에 저장하면 게시판같은 앱도 구현할 수 있음.
